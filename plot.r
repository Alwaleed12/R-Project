...
# The datasets R base packagecontains
...
# you give it and the data typpes of the variables you give it
?plot

# create a plot matrix of scatter lots for all
# the data in the iris data frame
plot(iris)

# give plot funciton categorical variable in iris data frame
# reference the name of the data frame, then use the $, and then
...
# give plot funciton 1 quantitative variable in iris data frame
...
# give plot function 1 categrorical variable and 1 quantitative
# variable
# plot function knew to generate a box plot
# x-axis is telling us the species
# y-axis is telling us the petal with range for the species
plot(iris$Species, iris$Petal.Width)

# give plot function 2 quantitative variables and other
# options the give the plot more meaning
...
# give the plot funciton a function
...
# give plot the dnorm funciton with options
plot(dnorm, -3, 3,
    col = "blue",   # color blue
